# Skills catalog — marketing / design / documents

> Moved out of the root `CLAUDE.md` (which is now the taxi build guide only).
> This catalog documents the 20 installed Claude skills and when each should
> auto-activate. It is **reference material for growth/design/ops work**, not part
> of the code repo's build rules. History: originally added and refined in PR #1.
...
1. **In this repo / Claude Code sessions** → *this file* documents the routing.
   The routing table below governs which skill fires.
