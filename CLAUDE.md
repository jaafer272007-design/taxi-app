...
Ride-hailing / taxi app (riders book rides, drivers accept them). This repo is
where the app is built; the installed **marketing** skills exist to promote and
grow it, and the **design** skill (`ui-ux-pro-max`) to build its UI.
